...
{
    public class PictureLayoutLeftDown : AbstractPictureLayout
    {
        public override Grid CreateLayout(List<ImageSource> imgSrcList)
        {
            ...
            cv_1.BorderThickness = new Thickness(0, 1, 1, 0);
            cv_1.Width = this.LittleImageWidth;
            cv_1.Height = this.LittleImageHeight;
            img_grid.Children.Add(cv_1);
            cv_1.HorizontalAlignment = HorizontalAlignment.Left;
            cv_1.VerticalAlignment = VerticalAlignment.Bottom;
